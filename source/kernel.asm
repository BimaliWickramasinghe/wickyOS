...
;WickyOS developed by Bimali Chathurika 
...
SEGMENT .data]
    	strWelcomeMsg		db	"Welcome wickyOS", 0x00
	strPrompt		db	"wicky>> ", 0x00
	cmdMaxLen		db	255			;maximum length of commands
	strOsName		db	"wicky", 0x00	;OS details
	...
	msgUnknownCmd		db	" Unknown command, Plese type help to get 'help' menu", 0x00
	strHelpMsg0		db 	" help  for help menu",0x00
	strHelpMsg1		db 	" ver   for version",0x00 
	strHelpMsg2		db 	" boot  for Reboot",0x00
	strHelpMsg3		db 	" exit  for shutdown",0x00
    	strHelpMsg4     	db 	" info  for hardware informations", 0x00
